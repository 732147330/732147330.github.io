...
app.config(function ($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('productDetail', {
      url: "/productDetail?skuId&cardId&ruleHeaderIdList&cardRenewalFlag",
        views: {
        "": {
    ...
    .state('mallOrder', {
        url: "/mallOrder?addressId&status&allflag&id&confirmRegulationsFlag&ruleHeaderIdList&skuId&cardId&cardRenewalFlag",
        views: {
        "": {
