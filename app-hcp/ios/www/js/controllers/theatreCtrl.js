 ...
 */
'use strict';
app.controller('theatreCtrl', function($scope,$rootScope,$stateParams,$ionicLoading,$cordovaGeolocation,$timeout,httpService,JYApi,$cordovaToast,$ionicPlatform,$ionicModal,$ionicBackdrop) {
    $scope.Number=Number;
