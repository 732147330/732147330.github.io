 ...
 */
'use strict';
app.controller('setUpCtrl', function ($scope, $rootScope,$cordovaStatusbar, httpService, JYApi, $ionicPlatform, $ionicViewSwitcher, $state, $timeout, $cordovaImagePicker, $cordovaToast, $ionicLoading, $ionicPopup, $interval) {
    ...
    $scope.clearCache = function () {
      $ionicPlatform.ready(function () {
            window.cache.clear(function (status) {
               //alert(decodeURIComponent(status));
                var myPopup = $ionicPopup.show({
                    title: languageSetting.tip,
                    cssClass: 'jyAlert jyAlert1',
