'use strict';
app.controller('categoryCtrl', function ($scope, $rootScope, httpService, JYApi, $stateParams, $state, $ionicPopup, $ionicPlatform, $timeout, $ionicScrollDelegate) {
