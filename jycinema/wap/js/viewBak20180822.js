...
app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('mallOrder', {
            url: "/mallOrder?addressId&status&allflag&id",
            views: {
                "": {
        ...
        .state('category', {
            url: "/category?catId&title&index&cinemaNameAlt&cinemaOuterId",
            views: {
                "": {
        ...
        .state('awardBigWheel', {
            url: "/awardBigWheel?lotteryDrawHeaderId&sourceId&shareCode",
            views: {
                "": {
