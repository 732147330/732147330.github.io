 ...
 */
'use strict';
app.controller('registerCtrl', function ($scope, $rootScope, $ionicPlatform, $interval, $stateParams, httpService, JYApi, $ionicPopup, $timeout, $state) {
    $scope.leftTime = 60;
    $scope.yzmFlag = true;
    $scope.invitationCode = $stateParams.invitationCode;
    $scope.sourceId = $stateParams.sourceId || '';
    $scope.shareCode = $stateParams.shareCode || '';
