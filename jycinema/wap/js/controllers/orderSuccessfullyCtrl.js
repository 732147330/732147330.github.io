 ...
 */
'use strict';
app.controller('orderSuccessfullyCtrl', function ($scope, $rootScope, $timeout, $ionicModal, httpService, JYApi, $stateParams, $state, $ionicScrollDelegate, $ionicPopup, $ionicGesture, $ionicBackdrop) {
    $scope.String = String;
    ...
    $scope.showQrCode = function (text, id, w, h) {
        console.log('showQrCode text:' + text)
        console.log('showQrCode id:' + id)
        ...
        console.log('showQrCode innerHTML:' + document.getElementById(id).innerHTML)
    };
    $scope.showProup = function (tit, text, id, w, h) {
        console.log('showProup')
