 ...
 */
'use strict';
app.controller('accountCtrl', function ($scope, $rootScope, $ionicPlatform,$ionicModal,$window, $timeout,$ionicBackdrop, $ionicPopup, $ionicActionSheet, $ionicViewSwitcher, $state, httpService, JYApi) {
        ...
        wx.chooseImage({
            ...
            success: function (res) {
                ...
                wx.getLocalImgData({
                    ...
                    success: function (res) {
                        var localData = res.localData.substring(res.localData.indexOf(','));
    ...
    $scope.buildProgressBar = function() {//构建进度条和宝箱
        ...
        for(var i = 0; i < arrLength;i++) {//取总进度宽度和邻近当前值的最大值
            if(i===0) continue;
