        ...
        httpService.getData(JYApi.findPlan, 'post', {
            ...
            if(res.status=='S'){
               ...
               $scope.memberLevelData=res.data.memberLevel;
                ...
                if($scope.pointData.length>0&&0<$scope.pointData[0].pointValue&&$scope.pointData[0].pointValue<=$scope.leveGrowData[0].tag){
                ...
                }else if($scope.pointData.length>0&&$scope.leveGrowData[0].tag<$scope.pointData[0].pointValue&&$scope.pointData[0].pointValue<=$scope.leveGrowData[1].tag){
                ...
                }else if($scope.pointData.length>0&&$scope.leveGrowData[1].tag<$scope.pointData[0].pointValue&&$scope.pointData[0].pointValue<=$scope.leveGrowData[2].tag){
                ...
                }else if($scope.pointData.length>0&&$scope.leveGrowData[2].tag<$scope.pointData[0].pointValue&&$scope.pointData[0].pointValue<=$scope.leveGrowData[3].tag){
                ...
                }else if($scope.pointData.length>0&&$scope.leveGrowData[3].tag<$scope.pointData[0].pointValue&&$scope.pointData[0].pointValue<=9999999){
                    $scope.high=true;
                    $scope.progress=90;
                }
            }
