 ...
 */
'use strict';
app.controller('invitedScanCtrl', function($scope,$rootScope,httpService,JYApi,$ionicScrollDelegate,$ionicActionSheet,$timeout,$ionicPopup,$state,$interval,$stateParams) {
    $scope.yzmFlag=true;
    $scope.leftTime=60;
    $scope.loginData={};
    ...
    $scope.buy=function(){
        if (!(/^1[34578]\d{9}$/.test($scope.loginData.tel2))) {
    ...
    //wap监听键盘打开
    //$scope.runTop=function(){
    //    $ionicScrollDelegate.$getByHandle('mainScroll').scrollTo(0, 100, [true])
    //}
