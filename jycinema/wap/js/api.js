 ...
 * wap 每次发布清除缓存
 */
// console.log("发布版本："+new Date().getTime());
var cacheTime = {
    divisionTime: '1572252158774',//每次发布重新生成 new Date().getTime()
    clearCache: function () {
...
cacheTime.clearCache();
localStorage.cacheTime = cacheTime.divisionTime;

var locals = {
  cur: 0,//0-正式环境，1-验证环境，2-准正式环境，其它-调试环境
  version: '1572252158774',//1571755399356
  urlList: [
    'http://www.jycinema.com',
    'http://sie-test.jycinema.com:6680',
    'http://private.jycinema.com',
    'https://www.jycinema.com',
    'http://192.168.29.32:8080',
    'http://192.168.27.92:8080',
    'http://192.168.27.91:80'
  ],
  baseUrl: function () {
...
app.constant('JYApi', {
  ...
  findAdvertisImageInfo: locals.urlList[3] + '/frontUIWebapp/appserver/cmsAdvertisementService/findAdvertisImageInfo',
  ...
  qqWapLogin: locals.baseUrl() + '/FrontInterfaceApp/frontServer/qqlogin/login',//QQ wap 登录
  sinaWapLogin: locals.baseUrl() + '/FrontInterfaceApp/frontServer/sinalogin/login',//新浪 wap 登录
  wxWapLogin: locals.baseUrl() + '/FrontInterfaceApp/frontServer/wxlogin/login',//微信 wap 登录
  loginWap: locals.baseUrl() + '/frontUIWebapp/appserver/wxLogin/loginWap',//微信 wap 登录新
  ...
  shareRegisterMember: locals.baseUrl() + '/frontUIWebapp/appserver/commonRegisterService/shareRegisterMember',
  ...
  findRightsCardDetail: locals.baseUrl() + '/frontUIWebapp/appserver/equitycardInfoService/findEquitycardInfo', saveEquitycard: locals.baseUrl() + '/frontUIWebapp/appserver/equitycardInfoService/saveEquitycard',
  ...
  //联通
  createBrandedCardOrders: locals.baseUrl() + '/frontUIWebapp/appserver/mallOrderServices/createBrandedCardOrders',
  findMyOrderInfo: locals.baseUrl() + '/frontUIWebapp/appserver/mallOrderServices/findMyOrderInfo',
  findVistaBookingId: locals.baseUrl() + '/frontUIWebapp/appserver/mallOrderServices/findVistaBookingId',
  //世界杯
  findMatchInfos: locals.baseUrl() + '/frontUIWebapp/appserver/guessingCompetitionService/findMatchInfos',
  submissionOptions: locals.baseUrl() + '/frontUIWebapp/appserver/guessingCompetitionService/submissionOptions',
  findguessingResults: locals.baseUrl() + '/frontUIWebapp/appserver/guessingCompetitionService/findguessingResults',
  findGuessingPrizeInfo: locals.baseUrl() + '/frontUIWebapp/appserver/guessingExchangeRecordService/findGuessingPrizeInfo',
  findAlreadyExchangeRecord: locals.baseUrl() + '/frontUIWebapp/appserver/guessingExchangeRecordService/findAlreadyExchangeRecord',
  findAllowExchangePrizeInfo: locals.baseUrl() + '/frontUIWebapp/appserver/guessingExchangeRecordService/findAllowExchangePrizeInfo',
  startExchangePrize: locals.baseUrl() + '/frontUIWebapp/appserver/guessingExchangeRecordService/startExchangePrize',
  //领券中心
