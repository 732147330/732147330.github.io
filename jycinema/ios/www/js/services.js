...
//ajax请求
  .factory('httpService', function ($http, $rootScope, $ionicLoading, $cordovaNetwork, $ionicPopup, $cordovaToast, $ionicPlatform, $timeout,$state) {
    var service = {};
    service.getData = function (path, method, params, callback, flag, text, isDorefresh) {
      ...
      if (params.params) {
        params.params = JSON.stringify(_.extend(JSON.parse(params.params), {channelId: 2}, {channelCode: "J0001"}, {memberId: memberId}));
      }
      ...
      $ionicPlatform.ready(function () {
        "use strict";
        if (locals.isMobile && $cordovaNetwork.isOffline()) {
          $cordovaToast
  ...
  //定位城市
  .factory('cityService', function ($http, $rootScope, $ionicPlatform, $timeout, $ionicPopup, httpService, JYApi, $cordovaGeolocation) {
    var service = {};
