 ...
 */
'use strict';
app.controller('rechargeCtrl', function($scope,$ionicPopup,$stateParams,httpService,JYApi,$state,$cordovaToast,$rootScope) {
    ...
    $scope.rechargeSubmit = function(obj) {
        if(!obj.$invalid){
            ...
            $state.go("chargePayment", {params:$scope.params});
        }
    };
